...
/**
 * @typedef {Object} dcEventFormat 장치에서 Event가 발생하여 연결 중인 모든 Commander에게 알려줘야 할 때 사용
...
/**
 * @typedef {Object} dcEventError CommandSet의 각각의 명령을 수행하는 도중 문제가 생길경우 해당 Commander에게 알려줘야할 때 사용
 * @property {commandFormat} commandSet 수행 명령 집합
 * @property {string} errorName 발생 에러 명
 * @property {Error} errorInfo 발생 이벤트 내용
 */  

/**
 * @typedef {Object} dcDataFormat CommandSet의 각각의 명령을 수행 결과 응답 데이터를 해당 Commander에게 알려줘야할 때 사용
 * @property {commandFormat} commandSet 수행 명령 집합
